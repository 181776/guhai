...
const REGION_BOSSES = {
  village: {
    ...
    emoji: '👑', sprite: 'assets/img/monsters/boss_village.png',
    desc: '吞没商路的巨型史莱姆，乌石村外最大的威胁。',
  },
  forest: {
    name: '狼王', mob: '野狼', title: '幽林兽王',
    emoji: '👑', sprite: 'assets/img/monsters/boss_forest.png',
    desc: '血月之下双眼赤红的兽王，血煞帮曾试图驯服它。',
  },
  ruins: {
    name: '骨将军', mob: '骷髅', title: '遗迹守将',
    emoji: '👑', sprite: 'assets/img/monsters/boss_ruins.png',
    desc: '青岚剑宗旧战场的亡魂聚合体，剑意未散。',
  },
  peak: {
    name: '血煞头目', mob: '山贼', title: '怒潮峰主',
    emoji: '👑', sprite: 'assets/img/monsters/boss_peak.png',
    desc: '占峰为王的匪首，赵凌亦需借其势上位。',
  },
  blaze: {
    name: '魔焰执事', mob: '骷髅', title: '余烬侵蚀者',
    emoji: '👑', sprite: 'assets/img/monsters/boss_blaze.png',
